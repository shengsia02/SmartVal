...
class Agent(models.Model):
    ...
    company = models.CharField(max_length=100, verbose_name='隸屬公司', blank=True, help_text="例如：信義房屋、永慶房屋")
    branch = models.CharField(max_length=100, verbose_name='分行名稱', blank=True, help_text="例如：大安店")
